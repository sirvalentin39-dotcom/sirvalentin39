// ============================================================================
//  Завантаження та розшифрування чутливої конфігурації (split-key схема).
// ----------------------------------------------------------------------------
//  Половина ключа (KEY_PART_CODE) зберігається тут, у коді застосунку.
//  Друга половина (поле "k") зберігається в приватному GitHub Gist разом із
//  зашифрованими даними (salt / iv / data). Лише ОБ'ЄДНАННЯ обох половин у
//  єдиний пароль дозволяє розшифрувати конфігурацію (AES-256-CBC + PBKDF2-SHA256).
//
//  Увага: це обфускація, а не абсолютний захист — клієнтський код завжди можна
//  дослідити в браузері. Мета — прибрати plaintext-секрети з публічного репо.
// ============================================================================
...
// Половина ключа, що зберігається в коді (друга половина — у Gist, поле "k").
